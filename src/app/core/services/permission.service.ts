...
export class PermissionService {
  ...
  private defaultPermissions: RoutePermission[] = [
    ...
    { path: '/reports', label: 'REPORTS', icon: 'pi pi-chart-bar', section: 'management', allowedRoles: ['owner', 'admin', 'manager'], requiredFeature: 'advanced_reports', requiredPermission: 'View Reports' },
    { path: '/reports/payments', label: 'Payment History', icon: 'pi pi-history', section: 'management', allowedRoles: ['owner', 'admin', 'manager'], requiredPermission: 'View Reports' },
    ...
    { path: '/support', label: 'Customer Support', icon: 'pi pi-question-circle', section: 'help', allowedRoles: ['owner', 'admin', 'manager', 'cashier', 'consumer'] },
    { path: '/products', label: 'PRODUCTS', icon: 'pi pi-th-large', section: 'shopping', allowedRoles: ['owner', 'admin', 'manager', 'cashier', 'consumer'], requiredPermission: 'Manage Products' },
    { path: '/cart', label: 'Cart', icon: 'pi pi-shopping-cart', section: 'shopping', allowedRoles: ['owner', 'admin', 'manager', 'cashier', 'consumer'], badge: true, requiredPermission: 'Process Sales' },
    { path: '/orders', label: 'My Orders', icon: 'pi pi-list', section: 'shopping', allowedRoles: ['owner', 'admin', 'manager', 'cashier', 'consumer'] },
    { path: '/profile', label: 'My Profile', icon: 'pi pi-user', section: 'account', allowedRoles: ['owner', 'admin', 'manager', 'cashier', 'consumer'] },
    ...
    { path: '/settings/products', label: 'INVENTORY_MANAGEMENT', icon: 'pi pi-box', section: 'inventory', allowedRoles: ['owner', 'admin', 'manager'], requiredPermission: 'Manage Products' },
    { path: '/settings/categories', label: 'CATEGORIES', icon: 'pi pi-tags', section: 'inventory', allowedRoles: ['owner', 'admin', 'manager'], requiredPermission: 'Manage Products' },
