...
export class PermissionService {
  ...
  private defaultPermissions: RoutePermission[] = [
    ...
    { path: '/settings/products', label: 'INVENTORY_MANAGEMENT', icon: 'pi pi-box', section: 'settings', allowedRoles: ['owner', 'admin', 'manager'], requiredPermission: 'Manage Products' },
    { path: '/settings/categories', label: 'CATEGORIES', icon: 'pi pi-tags', section: 'settings', allowedRoles: ['owner', 'admin', 'manager'], requiredPermission: 'Manage Products' },
